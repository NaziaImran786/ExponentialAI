...
// import { ArrowRight } from "lucide-react"
// import { client } from "@/sanity/lib/client"
// // import { blog } from '../../sanity/schemaTypes/blogs';
...
// // const res2: BlogPost[] = await client.fetch(`*[_type == "blogPost"]{
// //   id,
// //   title,
// //   subtitle,
// //   author,  
...
// const blogPosts = res.filter((item) => [2,3,4,5,6,7].includes(item.id));
...
//             <div className="relative h-[400px] rounded-lg overflow-hidden shadow-xl">
//               <Image
//                 src={ feature_post_data.image ||"/placeholder.svg?height=400&width=600"}
//                 alt="Featured blog post"
//                 fill
//                 className="object-cover"
//               />
...
//                 {feature_post_data.title}
//               </h2>
//               <p className="text-lg text-muted-foreground mb-6">
//                 {feature_post_data.subtitle}
//               </p>
//               <div className="flex items-center mb-6">
//                 <div className="relative h-10 w-10 rounded-full overflow-hidden mr-3">
//                   <Image src="/placeholder.svg?height=100&width=100" alt="Author" fill className="object-cover" />
...
//                 className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700"
//               >
//                 <Link href={`/blog/${feature_post_data._id}}`}>
//                 Read Full Article
//                 </Link>
//               </Button>
//             </div>
